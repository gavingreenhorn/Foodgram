    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ManyToManyField(related_name='buyers', through='recipes.ShoppingCart', to='recipes.recipe')),
                ('favorites', models.ManyToManyField(related_name='enjoyers', through='recipes.Favorite', to='recipes.recipe')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('subscriber', 'publisher'), name='unique_subscription'),
        ),
        migrations.AddConstraint(
            model_name='subscription',
            constraint=models.CheckConstraint(check=models.Q(('subscriber', models.F('publisher')), _negated=True), name='sub_to_self'),
        ),
    ]
